...
pub fn probe_patterns(provider: &str) -> Vec<String> {
    match provider {
        ...
        "glm4v" => vec!["https://api.z.ai/api/paas/v4/models".into()],
        "deepseek" => vec!["https://api.deepseek.com/v1/models".into()],
        "openai" => vec!["https://api.openai.com/v1/models".into()],
        "anthropic" => vec!["https://api.anthropic.com/v1/models".into()],
        "groq" => vec!["https://api.groq.com/openai/v1/models".into()],
        "google" => vec!["https://generativelanguage.googleapis.com/v1beta/models".into()],
        "scaleway" => vec![],
        _ => vec![],
    }
}
