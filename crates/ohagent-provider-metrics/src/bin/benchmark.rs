    ...
    match cli.command {
        ...
        Command::SpeedCompare => {
            ...
            let entries: Vec<(&str, &str, u64, u64, f64, &str)> = vec![
                ...
                ("Z.ai/Zhipu",  "GLM-4.5-Air",         2802, 2802,    37.3, "✅ measured (api.z.ai)"),
                ("Z.ai/Zhipu",  "GLM-5.2 (1M ctx)",    6799, 6799,     7.7, "✅ measured (api.z.ai)"),
                ("Z.ai/Zhipu",  "GLM-4.7",            15160,15160,     5.1, "✅ measured (api.z.ai)"),
